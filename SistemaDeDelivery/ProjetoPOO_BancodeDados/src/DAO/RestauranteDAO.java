...
public class RestauranteDAO {
    	 ...
    	 String sql = "SELECT * FROM restaurante";
    	    ...
    	    try (
    	        ...
    	        while (rs.next()) {
    	            ...
    	            r.setCategoriaCulinaria(rs.getString("categoriaculinaria"));
    ...
    public Restaurante buscarPorId(int id) {
        ...
        try (
            ...
            if (rs.next()) {
	            ...
	            r.setNome(rs.getString("nome"));
	            r.setTelefone(rs.getString("telefone"));
	            r.setTelefone(rs.getString("endereco"));
	            r.setCnpj(rs.getString("cnpj"));
	            r.setCategoriaCulinaria(rs.getString("categoriaculinaria"));
    ...
    public void atualizar(Restaurante r) {
        String sql = "UPDATE restaurante SET nome=?, telefone=?, endereco=?, cnpj=?, categoriaculinaria=? WHERE id_restaurante=?";
